 ...
 */
@ThreadSafe
public class SimilarityResultHandler implements ISimilarityResultHandler<ISimilarityResult> {
     ...
     */
    @Override
    public ISimilarityResult handler(final ISimilarityResult result) {
        return result;
    }
